...
<form action="#">
    <div class="mb-3">
        ...
        <trix-editor id="editor-answer{answer.id}" class="trix-content" bind:this={editorAnswer} input="answerText{answer.id}"></trix-editor>
        {@html savingStatus}
    </div>
    ...
    <div class="accordion my-2 " id="accordionAnswerHint{answer.id}">
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button text-body bg-body py-2 px-3 {showAnswerHint ? '' : 'collapsed'}"
                        type="button"
            ...
            <div id="collapseAnswerHint{answer.id}" class="accordion-collapse collapse {showAnswerHint ? 'show' : ''}">
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <trix-editor id="editor-answerHint{answer.id}" class="trix-content" bind:this={editorHint} input="answerHint{answer.id}" />
                        {@html savingStatus}
