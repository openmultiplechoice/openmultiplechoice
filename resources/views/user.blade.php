...
@section('content')
<form id="submit-user" action="/admin/users/{{ isset($user) ? $user->id : '' }}" method="post" class="mt-3 mb-3">
    @isset($user)
        @method('PUT')
    @endisset
    @csrf
...
<div class="row">
    <div class="col-md">
            ...
            <div class="row">
                ...
                @if(config('app.login.form') && isset($user))
            ...
            @isset($user)
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_verified_at" class="form-label">E-Mail verified</label>
